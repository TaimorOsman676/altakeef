...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 hidden lg:flex items-end gap-3">
      {/* Tooltip */}
      <div
      ...
      >
        ...
        {/* Main button */}
        <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/40 transition-all duration-300 active:scale-95">
          {/* WhatsApp SVG Icon */}
          <svg
